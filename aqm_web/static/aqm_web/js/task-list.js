...
(function() {
  var append_task, get_aermod_task_html, get_task_html, get_wrf_task_html, setup_task_auto_update;
  ...
  append_task = function(target, task) {
    var html, task_html;
    task_html = get_task_html(task);
    html = "<li id=\"task-" + task.kind + "-" + task.id + "\">\n    " + task_html + "\n</li>";
    $(target).append(html);
    return window.reinit_event_handler(task);
  };
  ...
  get_wrf_task_html = function(task) {
    ...
    if (task.get_status === "draft") {
      ...
      controls_html = "        <li><button class=\"btn btn-danger control-cancel\" data-loading-text=\"Cancel\" autocomplete=\"off\"><i class=\"icon-remove-sign icon-white\"></i> Cancel</button></li>\n<li><a class=\"btn\" href=\"" + task.get_url + "\"><i class=\"icon-th-list\"></i> Details</a></li>";
      ...
      controls_html = "        <li><button class=\"btn btn-danger control-stop\" data-loading-text=\"Stop\" autocomplete=\"off\"><i class=\"icon-stop icon-white\"></i> Stop</button></li>\n<li><a class=\"btn\" href=\"" + task.get_url + "\"><i class=\"icon-th-list\"></i> Details</a></li>";
      ...
      controls_html = "<li><button class=\"btn btn-info control-retry\" data-loading-text=\"Retry last stage\" autocomplete=\"off\"><i class=\"icon-refresh icon-white\"></i> Retry last stage</button></li>\n<li><button class=\"btn btn-info control-rerun\" data-loading-text=\"Run Again\" autocomplete=\"off\"><i class=\"icon-repeat icon-white\"></i> Run Again</button></li>\n<li><a class=\"btn\" href=\"" + task.get_url + "\"><i class=\"icon-th-list\"></i> Details</a></li>\n<li><a class=\"btn\" href=\"#\"><i class=\"icon-edit\"></i> Edit</a></li>\n<li><a class=\"btn btn-danger\" href=\"#\"><i class=\"icon-remove icon-white\"></i> Delete</a></li>";
  ...
  get_aermod_task_html = function(task) {
    var controls_html, error_html, html, pretty_error, progress_html;
    controls_html = "";
    progress_html = "";
    if (task.get_status === "draft") {
