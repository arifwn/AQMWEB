...
(function() {
  ...
  $(document).ready(function() {
    var all_pollutant_code, all_pollutant_name, current_pollutant, display_pollutant_list, i, pollutant_list, remove_pollutant, reset_available_pollutant, sheet, worksheets, _i, _len;
    pollutant_list = [];
    current_pollutant = [];
